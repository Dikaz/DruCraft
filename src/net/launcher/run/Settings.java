...
public class Settings
{
	...
	public static final String  domain	 	 = "192.168.1.110";//Домен сайта
	public static final String  siteDir		 = "web";//Папка с файлами лаунчера на сайте
	public static final String  updateFile		 = "http://192.168.1.110/web/Launcher.jar";//Ссылка на файл обновления лаунчера
